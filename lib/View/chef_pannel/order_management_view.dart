...
// import 'package:setuapp/View/chef_pannel/widgets/side_drawer_widget.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      onWillPop: () async {
        ...
        if (controller.showSideDrawer.value) {
          // If drawer is open, close it instead of exiting app
          controller.toggleSideDrawer();
          return false;
        } else if (controller.showCancelModal.value) {
          // If cancel modal is open, close it instead of exiting app
          controller.hideCancelOrderModal();
          return false;
        }
      ...
      child: Scaffold(
        ...
        body: Stack(
          children: [
            ...
            Obx(() => controller.showSideDrawer.value
                ? GestureDetector(
              onTap: () {
                controller.toggleSideDrawer();
              },
