              ...
              child: Column(
                children: [
                  ...
                  Obx(() => _buildMenuItem(
                    icon: Icons.receipt_long,
                    title: 'ORDERS',
                    isSelected: controller.selectedMenuItem.value == 'orders',
                    onTap: () {
                      controller.setSelectedMenuItem('orders');
                      controller.navigateToOrders();
                      controller.toggleSideDrawer(); // Close drawer
                    },
                  )),
                  ...
                  Obx(() => _buildMenuItem(
                    icon: Icons.settings,
                    title: 'SETTINGS',
                    isSelected: controller.selectedMenuItem.value == 'settings',
                    onTap: () {
                      controller.setSelectedMenuItem('settings');
