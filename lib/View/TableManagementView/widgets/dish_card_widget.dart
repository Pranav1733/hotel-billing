...
//           controller.getConfirmedQuantity(currentDish['id']);
      ...
      return GestureDetector(
        onTap: () {
          ...
          if (isSelected) {
            ...
            controller.updateDishQuantity(currentDish, 0);
          } else {
            // If not selected, select and set initial quantity to 1
            controller.updateDishQuantity(currentDish, 1);
          }
          // Call the original onTap callback if needed
          onTap();
        },
        child: Container(
          decoration: BoxDecoration(
