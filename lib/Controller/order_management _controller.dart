...
//   }
//
//   void setSelectedMenuItem(String s) {}
// }
...
class OrderManagementController extends GetxController {
  ...
  // Side drawer state
  final showSideDrawer = false.obs;
  final selectedMenuItem = 'orders'.obs; // Fixed: Made it reactive
  ...
  void navigateToSettings() {
    showSideDrawer.value = false;
    // You can replace this with your actual settings route
    // Get.toNamed('/settings');

    // For now, show a snackbar since settings page might not exist
    Get.snackbar(
      'Settings',
  ...
  // Navigate to orders (close drawer and refresh)
  void navigateToOrders() {
    showSideDrawer.value = false;
    refreshOrders();
  }
