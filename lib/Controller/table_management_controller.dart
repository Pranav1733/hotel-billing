...
class TableManagementController extends GetxController {
  ...
  // Filter options
  final filterOptions = ['All', 'Veg', 'Non-Veg', 'Indian', 'Chinese', 'Beverages', 'Liquor'].obs;
  ...
  void _disposeControllers() {
    if (customerNameController.hasListeners || customerNameController.text.isNotEmpty) {
  ...
  void initializeTables() {
    tables.value = List.generate(10, (index) => {
      'id': index + 1,
      'number': index + 1,
  ...
  void toggleDishSelection(Map<String, dynamic> dish) {
    ...
    if (index != -1) {
      availableDishes[index]['isSelected'] = !availableDishes[index]['isSelected'];
  ...
  double getTotalAmount() {
    return selectedDishes.fold(0.0, (total, dish) =>
  ...
  Future<void> completeOrder() async {
    ...
    try {
      ...
      final tableIndex = tables.indexWhere((t) =>
